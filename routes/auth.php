...
Route::prefix('auth')->group(function () {
	Route::get('/google', [AuthenticatedSessionController::class, 'redirectToGoogle'])->name('google');
	Route::get('/google/callback', [AuthenticatedSessionController::class, 'handleGoogleCallback']);

	Route::get('/facebook', [AuthenticatedSessionController::class, 'redirectToFacebook'])->name('facebook');
	Route::get('/facebook/callback', [AuthenticatedSessionController::class, 'handleFacebookCallback']);

	Route::get('/github', [AuthenticatedSessionController::class, 'redirectToGithub'])->name('github');
